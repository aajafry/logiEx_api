...
export const inventoryEmploymentsController = {
  create: async (req, res) => {
    try {
      await insertInventoryEmploymentSchema.parseAsync(req.body);
      const { employee_id, inventory } = req.body;
  ...
  updateById: async (req, res) => {
    try {
      await updateInventoryEmploymentSchema.parseAsync(req.body);
      const { id } = req.params;
